...
// Перевіряємо авторизацію. Якщо не авторизований - кидаємо на сторінку входу
if (!clientName) {
...
async function loadHistory() {
  ...
  // Витягуємо всі замовлення цього клієнта, новіші зверху
  ...
  // Групуємо товари за датою та часом (відкидаючи мілісекунди)
  const groupedOrders = {};
  data.forEach(item => {
